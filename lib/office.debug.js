...
console.warn(
    'You are referencing "office.debug.js" from a location that is being discontinued.' +
    '\n' +
    'Please update the HTML page for your task pane to use the following URL instead:' +
    '\n' +
