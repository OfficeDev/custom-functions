    ...
    (function (UI) {
        var RibbonGallery = (function () {
            ...
            RibbonGallery.prototype.refreshRibbon = function (jsParam) {
                if (OSF.RibbonGallery && OSF.RibbonGallery.refreshRibbon) {
                    OSF.RibbonGallery.refreshRibbon(jsParam);
                }
            };
            return RibbonGallery;
        })();
        UI.RibbonGallery = RibbonGallery;
...
OSF.InitializationHelper.prototype.prepareApiSurface = function OSF_InitializationHelper$prepareApiSurfaceAndInitialize(appContext) {
    ...
    appContext.ui.ribbonGallery = new OfficeExt.UI.RibbonGallery();
