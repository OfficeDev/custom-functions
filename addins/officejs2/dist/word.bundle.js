...
(function (OSF) {
    OSF.AppTelemetry = {
        logAppException: function (err) {
            OSF.OsfUtility.trace(err);
        },
        onRegisterDone: function (register, id, milliseconds, status) {
            OSF.OsfUtility.trace('' + register + ',' + milliseconds);
        },
    ...
    (function (Bootstrap) {
        ...
        function initialize() {
            return __awaiter(this, void 0, void 0, function () {
                var officeAppContext, appNumber;
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (_hostInfo.hostPlatform === OSF.HostInfoPlatform.web) {
                                _initializationHelper.saveAndSetDialogInfo(OSF.OsfUtility.getQueryStringValue("_host_Info"));
                            }
                        ...
                        case 1:
                            ...
                            _asyncMethodExecutor = _initializationHelper.createAsyncMethodExecutor(_clientHostController);
                            appNumber = officeAppContext.get_appName();
                            Office.fireOnReady({
                                host: OSF.HostName.Host.getInstance().getHost(appNumber),
                                platform: OSF.HostName.Host.getInstance().getPlatform(appNumber)
                            });
                            return [2, officeAppContext];
                    }
                });
            });
        }
        ...
        function retrieveHostInfo() {
            _hostInfo = { isO15: true, isRichClient: true, hostType: "", hostPlatform: "", hostSpecificFileVersion: "", hostLocale: "", osfControlAppCorrelationId: "", isDialog: false, disableLogging: false, flags: 0 };
            var hostInfoParaName = "_host_Info";
            var hostInfoValue = OSF.OsfUtility.getQueryStringValue(hostInfoParaName);
            if (!hostInfoValue) {
                try {
                    ...
                    OSF.OsfUtility.log(JSON.stringify(ex));
                }
            }
            if (!hostInfoValue) {
                try {
            ...
            if (hostInfoValue) {
                ...
                _hostInfo.isO15 = true;
                _hostInfo.hostLocale = OSF.OsfUtility.getQueryStringValue("locale");
            }
        }
        ...
        Bootstrap.getWindowName = getWindowName;
        function getWindowLocationHash() {
            return _windowLocationHash;
        }
        Bootstrap.getWindowLocationHash = getWindowLocationHash;
        function getWindowLocationSearch() {
            return _windowLocationSearch;
        }
        Bootstrap.getWindowLocationSearch = getWindowLocationSearch;
        function getClientHostController() {
            return _clientHostController;
        }
        Bootstrap.getClientHostController = getClientHostController;
        function getAsyncMethodExecutor() {
            return _asyncMethodExecutor;
        }
        Bootstrap.getAsyncMethodExecutor = getAsyncMethodExecutor;
        function getOfficeAppContext() {
            return _officeAppContext;
        }
        Bootstrap.getOfficeAppContext = getOfficeAppContext;
        function getHostInfo() {
            return _hostInfo;
        }
        Bootstrap.getHostInfo = getHostInfo;
        ...
        Bootstrap.getCachedSessionSettingsKey = getCachedSessionSettingsKey;
    })(Bootstrap = OSF.Bootstrap || (OSF.Bootstrap = {}));
})(OSF || (OSF = {}));
var OSF;
(function (OSF) {
    ...
    var EventHelper = (function () {
        ...
        EventHelper.addEventHandler = function (eventType, handler, callback, eventDispatch, isPopupWindow) {
            ...
            function onEnsureRegistration(status) {
                ...
                var asyncMethodExecutor = OSF.Bootstrap.getAsyncMethodExecutor();
            ...
            try {
                ...
                if (count == 0) {
                    ...
                    asyncMethodExecutor.registerEventAsync(dispId, eventInfo.type, targetId, function (eventArgs) {
                        ...
                        onEnsureRegistration(OSF.OsfUtility.getErrorCodeFromAsyncResult(result));
                    });
                }
                else {
                    onEnsureRegistration(0);
    ...
    (function (HostName) {
        var Host = (function () {
            function Host() {
                ...
                this.hostInfo = OSF.Bootstrap.getHostInfo();
            }
...
(function (OSF) {
    var InitializationHelper = (function () {
        ...
        InitializationHelper.prototype.createAsyncMethodExecutor = function (clientHostControler) {
            return null;
        };
        InitializationHelper.prototype.deserializeSettings = function (serializedSettings) {
            ...
            if (osfSessionStorage) {
                var storageSettings = osfSessionStorage.getItem(OSF.Bootstrap.getCachedSessionSettingsKey());
                if (storageSettings) {
                    serializedSettings = JSON.parse(storageSettings);
                }
                else {
                    storageSettings = JSON.stringify(serializedSettings);
                    osfSessionStorage.setItem(OSF.Bootstrap.getCachedSessionSettingsKey(), storageSettings);
                }
            }
...
(function (OSF) {
    var OUtil = (function () {
        ...
        OUtil.isDate = function (obj) {
            return Object.prototype.toString.apply(obj) === "[object Date]";
        };
        OUtil.addEventListener = function (element, eventName, listener) {
        ...
        OUtil.removeEventListener = function (element, eventName, listener) {
        ...
        OUtil.serializeSettings = function (settingsCollection) {
            var ret = {};
            for (var key in settingsCollection) {
                var value = settingsCollection[key];
                try {
                    value = JSON.stringify(value, function dateReplacer(k, v) {
                        return OSF.OUtil.isDate(this[k]) ? OUtil.DateJSONPrefix + this[k].getTime() + OUtil.DataJSONSuffix : v;
                    });
                    ret[key] = value;
                }
                catch (ex) {
        ...
        OUtil.deserializeSettings = function (serializedSettings) {
            var ret = {};
            ...
            for (var key in serializedSettings) {
                ...
                try {
                    value = JSON.parse(value, function dateReviver(k, v) {
                        var d;
                        if (typeof v === 'string' && v && v.length > 6 && v.slice(0, 5) === OUtil.DateJSONPrefix && v.slice(-1) === OUtil.DataJSONSuffix) {
        ...
        OUtil.getSessionStorage = function () {
            if (!OUtil._safeSessionStorage) {
                try {
                ...
                OUtil._safeSessionStorage = new OSF.SafeStorage(sessionStorage);
            }
            return OUtil._safeSessionStorage;
        };
        OUtil.convertIntToCssHexColor = function (val) {
            var hex = "#" + (Number(val) + 0x1000000).toString(16).slice(-6);
            return hex;
        };
        OUtil.parseAppContextFromWindowName = function (skipSessionStorage, windowName) {
            return OUtil.parseInfoFromWindowName(skipSessionStorage, windowName, OSF.WindowNameItemKeys.AppContext);
        };
        OUtil.parseHostInfoFromWindowName = function (skipSessionStorage, windowName) {
            return OSF.OUtil.parseInfoFromWindowName(skipSessionStorage, windowName, OSF.WindowNameItemKeys.HostInfo);
        };
        OUtil.parseXdmInfo = function (skipSessionStorage) {
        ...
        OUtil.parseXdmInfoFromWindowName = function (skipSessionStorage, windowName) {
            return OSF.OUtil.parseInfoFromWindowName(skipSessionStorage, windowName, OSF.WindowNameItemKeys.XdmInfo);
        };
        OUtil.parseXdmInfoWithGivenFragment = function (skipSessionStorage, fragment) {
            return OSF.OUtil.parseInfoWithGivenFragment(OUtil._xdmInfoKey, OUtil._xdmSessionKeyPrefix, false, skipSessionStorage, fragment);
        };
        OUtil.parseSerializerVersion = function (skipSessionStorage) {
        ...
        OUtil.parseSerializerVersionFromWindowName = function (skipSessionStorage, windowName) {
            return parseInt(OSF.OUtil.parseInfoFromWindowName(skipSessionStorage, windowName, OSF.WindowNameItemKeys.SerializerVersion));
        };
        OUtil.parseSerializerVersionWithGivenFragment = function (skipSessionStorage, fragment) {
            return parseInt(OSF.OUtil.parseInfoWithGivenFragment(OUtil._serializerVersionKey, OUtil._serializerVersionKeyPrefix, true, skipSessionStorage, fragment));
        };
        OUtil.parseInfoFromWindowName = function (skipSessionStorage, windowName, infoKey) {
            try {
        ...
        OUtil.parseInfoWithGivenFragment = function (infoKey, infoKeyPrefix, decodeInfo, skipSessionStorage, fragment) {
            ...
            if (decodeInfo && infoValue != null) {
                if (infoValue.indexOf(OUtil._fragmentInfoDelimiter) >= 0) {
                    infoValue = infoValue.split(OUtil._fragmentInfoDelimiter)[0];
                }
        ...
        OUtil.getConversationId = function () {
        ...
        OUtil.getInfoItems = function (strInfo) {
        ...
        OUtil.getXdmFieldValue = function (xdmFieldName, skipSessionStorage) {
            var fieldValue = '';
        ...
        OUtil._reOrderTabbableElements = function (elements) {
            var bucket0 = [];
            var bucketPositive = [];
            var i;
        ...
        ;
        OUtil.focusToFirstTabbable = function (all, backward) {
            var next;
            var focused = false;
            var candidate;
            ...
            all = OUtil._reOrderTabbableElements(all);
        ...
        OUtil.focusToNextTabbable = function (all, curr, shift) {
            var currPos;
            var next;
            var focused = false;
            var candidate;
        ...
        OUtil._uniqueId = -1;
        OUtil._xdmInfoKey = '&_xdm_Info=';
        OUtil._serializerVersionKey = '&_serializer_version=';
        OUtil._xdmSessionKeyPrefix = '_xdm_';
        OUtil._serializerVersionKeyPrefix = '_serializer_version=';
        OUtil._fragmentSeparator = '#';
        OUtil._fragmentInfoDelimiter = '&';
        OUtil.DateJSONPrefix = "Date(";
        OUtil.DataJSONSuffix = ")";
        return OUtil;
    }());
    OSF.OUtil = OUtil;
})(OSF || (OSF = {}));
...
(function (Office) {
    ...
    (function (context) {
        ...
        (function (document) {
            function get_url() {
                return OSF.Bootstrap.getOfficeAppContext().get_docUrl();
            }
            OSF.definePropertyOnNamespace(document, 'url', get_url);
            function get_mode() {
                var clientMode = OSF.Bootstrap.getOfficeAppContext().get_clientMode();
                if (clientMode == 0) {
            ...
            function get_settings() {
                if (!_settings) {
                    var settingsFunc = OSF.Bootstrap.getOfficeAppContext().get_settingsFunc();
...
(function (Office) {
    ...
    (function (context) {
        ...
        function get_diagnostics() {
            return OSF.HostName.Host.getInstance().getDiagnostics(OSF.Bootstrap.getOfficeAppContext().get_hostFullVersion());
        }
        OSF.definePropertyOnNamespace(context, 'diagnostics', get_diagnostics);
        var _requirements;
        function get_requirements() {
            if (!_requirements) {
                var appContext = OSF.Bootstrap.getOfficeAppContext();
        ...
        function get_officeTheme() {
            if (!_officeTheme) {
                var func = OSF.Bootstrap.getOfficeAppContext().get_officeThemeFunc();
                if (func) {
                    _officeTheme = func();
                }
                else {
...
(function (Office) {
    ...
    function ensureOfficeOnReadyPromise() {
        if (!_officeOnReadyPromise) {
            _officeOnReadyPromise = new Promise(function (resolve, reject) {
...
(function (OSF) {
    ...
    var XdmServiceEndPoint = (function () {
        ...
        XdmServiceEndPoint.prototype.registerMethod = function (methodName, method, invokeType, blockingOthers) {
            if (invokeType !== 0
                && invokeType !== 1) {
                throw OSF.OsfUtility.createArgumentException("invokeType");
            }
        ...
        XdmServiceEndPoint.prototype.registerConversation = function (conversationId, conversationUrl, appDomains, serializerVersion) {
            OSF.OsfUtility.log("registerConversation: cId=" + conversationId + " Url=" + conversationUrl);
            if (appDomains) {
                if (!Array.isArray(appDomains)) {
                    throw OSF.OsfUtility.createArgumentException("appDomains");
                }
        ...
        XdmServiceEndPoint.prototype.setPolicyManager = function (policyManager) {
            if (!policyManager.checkPermission) {
                throw OSF.OsfUtility.createArgumentException("policyManager");
            }
    ...
    (function (XdmCommunicationManager) {
        ...
        function _lookupServiceEndPoint(conversationId) {
            ...
            throw OSF.OsfUtility.createArgumentException("conversationId");
        }
        ;
        function _lookupClientEndPoint(conversationId) {
            var clientEndPoint = _clientEndPoints[conversationId];
            if (!clientEndPoint) {
                OSF.OsfUtility.log("Unknown conversation Id.");
            }
        ...
        function _lookupMethodObject(serviceEndPoint, messageObject) {
            ...
            if (!methodOrEventMethodObject) {
                OSF.OsfUtility.log("The specified method is not registered on service endpoint:" + messageObject._actionName);
                throw OSF.OsfUtility.createArgumentException("messageObject");
            }
        ...
        function _dequeInvoker() {
            if (_messageProcessingTimer !== null) {
                ...
                OSF.OsfUtility.log("channel is not ready.");
            }
        }
        ;
        ...
        function _registerListener(listener) {
            if (window.addEventListener) {
                ...
                OSF.OsfUtility.log("Browser doesn't support the required API.");
                throw OSF.OsfUtility.createArgumentException("Browser");
            }
        }
        ;
        ...
        function _receive(e) {
            if (e.data != '') {
                ...
                OSF.OsfUtility.debugLog(serializedMessage);
                if (messageObject._messageType === 0) {
                    ...
                    try {
                        ...
                        OSF.OsfUtility.log("_receive: request, origin=" + requesterUrl + " sourceURL:" + serviceEndPoint._conversations[messageObject._conversationId]);
                        ...
                        OSF.OsfUtility.log("_receive: request, origin=" + requesterUrl + " sourceURL:" + conversation.url);
                    ...
                    OSF.OsfUtility.log("_receive: response, origin=" + e.origin + " targetURL:" + clientEndPoint._targetUrl);
        ...
        function XdmResponseSender(requesterWindow, requesterUrl, actionName, conversationId, correlationId, responseType, serializerVersion) {
            ...
            this._send = function (result) {
                try {
                    ...
                    OSF.OsfUtility.log("_send: requestUrl=" + _this._requesterUrl + " _actionName:" + _this._actionName);
                }
                catch (ex) {
                    OSF.OsfUtility.log("ResponseSender._send error:" + ex.message);
                }
            };
        }
        ...
        function XdmInvokeCompleteCallback(requesterWindow, requesterUrl, actionName, conversationId, correlationId, postCallbackHandler, serializerVersion) {
            ...
            _this._send = function (result, responseCode) {
                ...
                try {
                    ...
                    OSF.OsfUtility.log("InvokeCompleteCallback._send error:" + ex.message);
                }
            };
            return _this;
        }
...
var OSF;
(function (OSF) {
    var OsfUtility = (function () {
        function OsfUtility() {
        }
        OsfUtility.createArgumentException = function (name) {
            return new Error("Invalid argument " + name);
        };
        OsfUtility.createNotImplementedException = function () {
            return new Error("Not implemented yet");
        };
        OsfUtility.log = function (message) {
            console.log(message);
        };
        OsfUtility.trace = function (message) {
            console.log(message);
        };
        OsfUtility.debugLog = function (message) {
            console.log(message);
        };
        OsfUtility.createPromiseFromResult = function (result) {
            return Promise.resolve(result);
        };
        OsfUtility.compareVersions = function (version1, version2) {
        ...
        OsfUtility.getQueryStringValue = function (paramName) {
        ...
        OsfUtility.getErrorCodeFromAsyncResult = function (asyncResult) {
    ...
    var RichClientInitializationHelper = (function (_super) {
            ...
            if (!this._osfControlContext) {
                ...
                try {
                    if (window.external && typeof window.external.GetContext !== 'undefined') {
                        ...
                        OSF.OsfUtility.trace(warningText);
                        return;
                    }
                }
                catch (e) {
        ...
        RichClientInitializationHelper.prototype.getAppContext = function () {
            ...
            if (typeof context.GetFeaturesForSolution != "undefined") {
                try {
                    ...
                    OSF.OsfUtility.trace("Exception while creating the SDX FeatureGates object. Details: " + ex);
                }
            }
            ...
            return OSF.OsfUtility.createPromiseFromResult(returnedContext);
        };
        RichClientInitializationHelper.prototype.createClientHostController = function () {
            if (this._hostInfo.hostPlatform === OSF.HostInfoPlatform.win32) {
                return new OSF.Win32RichClientHostController();
            }
            else {
                throw OSF.OsfUtility.createNotImplementedException();
            }
        };
        RichClientInitializationHelper.prototype.createAsyncMethodExecutor = function (clientHostController) {
            return new OSF.SafeArrayAsyncMethodExecutor(clientHostController);
        };
...
(function (OSF) {
    var WebInitializationHelper = (function (_super) {
        ...
        WebInitializationHelper.prototype.saveAndSetDialogInfo = function (hostInfoValue) {
            ...
            if (osfSessionStorage) {
                if (!hostInfoValue) {
                    hostInfoValue = OSF.OUtil.parseHostInfoFromWindowName(true, OSF.Bootstrap.getWindowName());
                }
        ...
        WebInitializationHelper.prototype.setAgaveHostCommunication = function () {
            try {
                var me = this;
                var xdmInfoValue = OSF.OUtil.parseXdmInfoWithGivenFragment(false, OSF.Bootstrap.getWindowLocationHash());
                if (!xdmInfoValue) {
                    xdmInfoValue = OSF.OUtil.parseXdmInfoFromWindowName(false, OSF.Bootstrap.getWindowName());
                }
                if (xdmInfoValue) {
                ...
                var serializerVersion = OSF.OUtil.parseSerializerVersionWithGivenFragment(false, OSF.Bootstrap.getWindowLocationHash());
                if (isNaN(serializerVersion)) {
                    serializerVersion = OSF.OUtil.parseSerializerVersionFromWindowName(false, OSF.Bootstrap.getWindowName());
                }
                    ...
                    switch (actionId) {
                        ...
                        case 4:
                            ...
                            if (!focused) {
                                window.blur();
                                me._webAppState.focused = false;
                                me._webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [me._webAppState.id, 17]);
                            }
                            break;
                        case 12:
                            window.focus();
                            ...
                            if (!focused) {
                                window.blur();
                                me._webAppState.focused = false;
                                me._webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [me._webAppState.id, 18]);
                            }
                            break;
                        case 25:
                            throw OSF.OsfUtility.createNotImplementedException();
                        ...
                        case 31:
                            ...
                            break;
                        default:
                            OSF.OsfUtility.trace("actionId " + actionId + " notifyAgave is wrong.");
                            break;
                    }
                };
            ...
            return new Promise(function (resolve, reject) {
                var getInvocationCallbackWebApp = function (errorCode, appContext) {
                    ...
                    if (!me._hostInfo.isDialog || window.opener == null) {
                        ...
                        me._webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [me._webAppState.id, 21, pageUrl]);
                    }
                ...
                try {
                    if (_this._hostInfo.isDialog && window.opener != null) {
                        var appContext = OSF.OUtil.parseAppContextFromWindowName(false, OSF.Bootstrap.getWindowName());
        ...
        WebInitializationHelper.prototype.createClientHostController = function () {
            return new OSF.WebClientHostController(this._webAppState);
        };
        WebInitializationHelper.prototype.createAsyncMethodExecutor = function (clientHostController) {
            return new OSF.WebAsyncMethodExecutor(clientHostController);
        };
        WebInitializationHelper.prototype.addOrRemoveEventListenersForWindow = function (isAdd) {
            ...
            var onWindowFocus = function () {
                ...
                me._webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [me._webAppState.id, 0]);
            };
            var onWindowBlur = function () {
                ...
                me._webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [me._webAppState.id, 1]);
            };
                ...
                if (e.keyCode == 117 && (e.ctrlKey || e.metaKey)) {
                    ...
                    if (!focused) {
                        if (me._hostInfo.isDialog) {
                            ...
                            if (e.shiftKey) {
                                me._webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [me._webAppState.id, 14]);
                            }
                            else {
                                me._webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [me._webAppState.id, 13]);
                            }
                        }
                    }
                }
                    ...
                    e.preventDefault();
                    me._webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [me._webAppState.id, 15]);
                }
                else if (e.keyCode == 113) {
                    e.preventDefault();
                    me._webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [me._webAppState.id, 16]);
                }
            };
...
(function (OfficeRuntime) {
    ...
    (function (experimentation) {
        function getBooleanFeatureGate(featureName, defaultValue) {
            try {
                var featureGates = OSF.Bootstrap.getOfficeAppContext().get_featureGates();
